...
const experience = {  
  ...
  description: "I am a Flutter Google Developer Expert (GDE) and experienced software developer specializing in mobile and web development.",  
  sections: [  
    {  
      title: "Work",  
      experiences: [  
        {  
          ...
          description: "Teaching mobile development, cloud computing, and software engineering courses.",  
          color: "#000000"  
        },  
        {  
          ...
          location: "Remote",  
          description: "Working as a Flutter Google Developer Expert, creating educational content.",  
          color: "#4285F4"  
        }  
      ]  
    },  
    {  
      ...
      experiences: [  
        {  
          ...
          duration: "2021 - Present",  
          location: "Online",  
          description: "Creating comprehensive Flutter and mobile development courses.",  
          color: "#0071C5"  
        },  
        {  
          ...
          duration: "2020 - Present",  
          location: "Online",  
          description: "Developing and maintaining popular Flutter development courses.",  
          color: "#A435F0"  
        },  
        {  
          ...
          duration: "2020 - Present",  
          location: "Online",  
          description: "Creating educational content focused on Flutter and mobile development.",  
          color: "#FF0000"  
        }  
      ]  
    }  
...
const publicationsHeader = {  
  ...
  description: "My academic research, technical content, and educational materials across various platforms including academic journals, YouTube, GitHub, and online learning platforms.",  
...
const publications = {  
  data: [  
    ...
    {  
      ...
      name: "Türkçe Metinler için Duygu Analizi Yaklaşımı ile İletişimde Bağlamdan Bağımsız Modellerin Geliştirilmesi",  
      createdAt: "2021",  
      description: "Research on developing context-independent models for Turkish text sentiment analysis, published in Yeni Medya Elektronik Dergisi",  
    ...
    {  
      ...
      createdAt: "2023",  
      description: "Comprehensive course covering Flutter architecture, Firebase integration, state management, and real-world application development",  
    ...
    {  
      ...
      createdAt: "2023",  
      description: "Free Flutter development course covering fundamentals to advanced topics",  
      url: "https://www.btkakademi.gov.tr/portal/course/flutter-ile-mobil-uygulama-gelistirme-23237",  
      type: "course",  
    ...
    {  
      ...
      createdAt: "2023",  
      description: "Comprehensive video series covering Flutter development, Firebase integration, and real-world applications",  
    ...
    {  
      ...
      createdAt: "2023",  
      description: "Interactive live coding sessions focusing on Flutter development and problem-solving",  
      url: "https://www.youtube.com/@HiCoders",  
      type: "live_content",  
      platform: "YouTube"  
    }  
...
const projects = {  
  data: [  
    ...
    {  
      ...
      description: "Production-ready Flutter architecture template with MVVM pattern, dependency injection, and best practices",  
    ...
    {  
      id: "flutter-ready",  
      name: "Flutter Ready",  
      description: "Ready-to-use Flutter components and utilities for rapid development",  
    ...
    {  
      id: "foody",  
      name: "Foody",  
      description: "A complete food delivery application built with Flutter and Firebase",  
...
const projectsHeader = {  
  ...
  description: "My projects demonstrate expertise in Flutter, Firebase, and full-stack development. They range from architecture templates and educational resources to complete applications, all focused on helping developers build better mobile applications.",  
  avatar_image_path: "projects_image.svg",  
};
